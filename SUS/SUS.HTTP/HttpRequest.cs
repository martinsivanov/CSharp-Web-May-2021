...
namespace SUS.HTTP
{
    public class HttpRequest
    {
        ...
        private static void SplitParameters(string parameterAsString, IDictionary<string,string> output)
        {
            var parameters = parameterAsString.Split(new char[] { '&' }, StringSplitOptions.RemoveEmptyEntries);
